<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CV_SİTESİ_CORE.WebForm1" %>
...
<head>
    ...
    <title>WEB BLOG CV SİTESİ</title>

    <!-- Bootstrap core CSS -->
    <link href="AspBlog/startbootstrap-resume-gh-pages/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">


    <!-- Custom fonts for this template -->
    <link href="https://fonts.googleapis.com/css?family=Saira+Extra+Condensed:500,700" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Muli:400,400i,800,800i" rel="stylesheet">
    <link href="AspBlog/startbootstrap-resume-gh-pages/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="AspBlog/startbootstrap-resume-gh-pages/css/resume.min.css" rel="stylesheet" />
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#awards">Katıldığım Konferanslar</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container-fluid p-0">
                    ...
                    <div class="my-auto">
                        ...
                        <div class="subheading mb-5">
                            ...
                            <asp:Label ID="Label4" runat="server" Text='<%# Eval("TELEFON") %>'></asp:Label><p></p>
                               ...
                               İletişim:
                            <asp:Label ID="Label5" runat="server" Text='<%# Eval("MAİL") %>'></asp:Label></a>
                        </div>
                        <p class="lead mb-5">
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="skills">
            <div class="my-auto">
                ...
                <div class="subheading mb-3">Programalama Dilleri</div>
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="awards">
            <div class="my-auto">
                <h2 class="mb-5">Katıldığım Konferanslar</h2>
                    ...
                    <ItemTemplate>
                        ...
                        <ul class="fa-ul mb-0">
                            <li>
                                ...
                                <asp:Label ID="Label17" runat="server" Text='<%# Eval("KONFERANSLAR") %>'></asp:Label></li>
                            <li>
                        </ul>
                    </ItemTemplate>
                </asp:Repeater>
    ...
    <script src="AspBlog/startbootstrap-resume-gh-pages/vendor/jquery/jquery.min.js"></script>
    <script src="AspBlog/startbootstrap-resume-gh-pages/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Plugin JavaScript -->
    <script src="AspBlog/startbootstrap-resume-gh-pages/vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Custom scripts for this template -->

    <script src="AspBlog/startbootstrap-resume-gh-pages/js/resume.min.js"></script>
</body>
